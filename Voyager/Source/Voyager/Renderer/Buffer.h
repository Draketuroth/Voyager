...
namespace VE
{
	namespace Rendering 
	{
		...
		{
			BufferElement() : _name(""), _type(ShaderDataType::None), _size(0), _offset(0), _normalized(false) {}
		...
		class VOYAGER_API VertexBuffer
		{
		public:
			...
			static VertexBuffer* create(float* vertices, std::uint32_t size, std::uint32_t count);
		};

		class VOYAGER_API IndexBuffer
		{
		public:
			virtual ~IndexBuffer() {};
